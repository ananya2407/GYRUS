...
class Employee(models.Model):
    ...
    clumpThickness=models.FloatField(blank= False, null= True)
    uniformityCellSize=models.FloatField(blank= False, null= True)
    uniformityCellShape=models.FloatField(blank= False, null= True)
    marginalAdhesion=models.FloatField(blank= False, null= True)
    singleEpithelialCellSize=models.FloatField(blank= False, null= True)
    bareNuclei=models.FloatField(blank= False, null= True)
    blandChromatin=models.FloatField(blank= False, null= True)
    normalNucleoli=models.FloatField(blank= False, null= True)
    mitoses=models.FloatField(blank= False, null= True)
